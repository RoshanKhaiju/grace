        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 pr-4">
                <div class="widget clearfix">
                    <h3 class="ls0 nott">Grace Culinary Academy</h3>
                    <p>Dukuchhap, Godawari Municipality-8, Lalitpur</p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-6">
                <div class="widget clearfix">
                    ...
                    <ul class="list-unstyled ml-0">
                        <li class="mb-2">
                            Email :
                            <a href="mailto:abc@email.com" class="text-black-50">abc@email.com</a>
                        </li>
                        <li class="mb-2">
                            Phone :
                            <a href="tel:1234567890" class="text-black-50">1234567890</a>
                        </li>
                    </ul>
                </div>
            </div>
