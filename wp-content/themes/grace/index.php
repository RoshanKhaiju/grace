            ...
            <div id="rev_slider_2_1" class="rev_slider fullscreenbanner" style="display: none" data-version="5.4.8.1">
                <ul>
                    ...
                    <li data-index="rs-7" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        data-thumb="<?php echo get_template_directory_uri() . '/assets/demos/recipes/images/slider/1/100x50-bg.jpg' ?>"
                        data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                        data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                        data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo get_template_directory_uri() . '/assets/demos/recipes/images/slider/dummy.png' ?>"
                            alt="Image" data-duration="4000" data-lazyload="demos/recipes/images/slider/banner-1.jpg"
                        ...
                        <p class="tp-caption Restaurant-Description" id="slide-7-layer-13-2"
                            ...
                            cook?
                            <!-- We will give you 5-days a week of practical bulk cooking based on the Australian TAFE system in our fully equipped commercial kitchen. -->
                        </p>
                        ...
                        <div class="tp-caption" id="slide-7-layer-20" data-x="['left','left','left','middle']"
                            ...
                            data-textAlign="['inherit','inherit','left','center']"
                            style="z-index: 14;white-space: normal;font-size: 20px;line-height: 22px;font-weight: 400;color: #ffffff;">
                        ...
                        <a class="tp-caption rev-btn button button-large m-0 button-white font-weight-bold button-circle button-grace text-capitalize"
                            href="demos/recipes/recipe-single.html" target="_blank" id="slide-7-layer-13"
                            data-x="['left','left','left','middle']" data-hoffset="['0','30','0','0']"
                            ...
                            style="z-index: 9; padding: 4px 28px"><span>View Course</span> <i
                    ...
                    <li data-index="rs-8" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<?php echo get_template_directory_uri() . '/assets/demos/recipes/images/slider/dummy.png' ?>"
                            alt="Image" data-duration="4000" data-lazyload="demos/recipes/images/slider/bg-2.jpg"
                            data-bgposition="center center" data-bgfit="cover" data-bgparallax="4" class="rev-slidebg"
                            data-no-retina />
                        <!-- LAYERS -->
                        ...
                        <h3 class="tp-caption font-primary mb-3" id="slide-7-layer-13-1"
                            ...
                            data-textAlign="['inherit','inherit','left','center']"
                            style="
                      z-index: 7;white-space: nowrap;font-size: 54px;line-height: 54px;letter-spacing: 0px;color: #fff;">
                            Grace Culinary Academy
                        </h3>
                    ...
                    ">
                        ...
                        <a class="tp-caption rev-btn button button-large m-0 button-white font-weight-bold button-circle button-grace text-capitalize"
                            href="assets/documents/course.pdf" target="_blank" id="slide-7-layer-13"
                            data-x="['left','left','left','middle']" data-hoffset="['0','30','0','0']"
                            data-y="['middle','middle','bottom','bottom']" data-voffset="['200','200','280','20']"
                            data-width="auto" data-height="auto" data-type="button" data-actions=""
                            data-responsive_offset="off" data-responsive="off" data-fontsize="['18', '15', '15', '15']"
